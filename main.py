...
tela.pack()
saudacao = Label(root, bg='#1d1d1d',fg='#8e27ea', font=('Comic Sans MS', 16))                  
saudacao.pack()
data = Label(root, bg='#1d1d1d',fg='#8e27ea', font=('Comic Sans MS', 14))  
data.pack(pady=2)
horas = Label(root, bg='#1d1d1d',fg='#8e27ea', font=('Comic Sans MS', 64, 'bold'))
horas.pack(pady=2) 
get_saudacao()
get_data()
get_horas()
